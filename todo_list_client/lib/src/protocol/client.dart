...
import 'package:todo_list_client/src/protocol/todo.dart' as _i3;
...
class _EndpointTodo extends _i1.EndpointRef {
  ...
  _i2.Future<List<_i3.Todo>> get() => caller.callServerEndpoint<List<_i3.Todo>>(
        'todo',
        'get',
        {},
      );
  ...
  _i2.Future<void> delete(String id) => caller.callServerEndpoint<void>(
        'todo',
        'delete',
        {'id': id},
      );
  ...
  _i2.Future<_i3.Todo?> getById(int? id) =>
